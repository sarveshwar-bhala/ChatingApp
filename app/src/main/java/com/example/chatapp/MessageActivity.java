...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_message=findViewById(R.id.btn_send_message);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(user.getImageURL().equals("default")){
                    ...
                    profile_image_Message.setImageResource(R.mipmap.ic_launcher);


                }else {

                    //change this from messageactivity.this to getapplicationcontext()
                    Glide.with(getApplicationContext()).load(user.getImageURL()).into(profile_image_Message);
                }
